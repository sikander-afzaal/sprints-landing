...
const Idea = () => {
  return (
    <div className="wrapper  sm:mt-[90px] xl:mt-[150px]">
      <div className="contain flex-col justify-center items-center gap-[50px] xl:gap-[100px]">
        ...
        <div className="flex justify-start items-start flex-col gap-5 ">
          <p className="text-base sm:text-xl xl:text-[26px] font-medium text-white">
            Creating a startup is a journey full of challenges, but we're here
          ...
          <p className="text-base sm:text-xl xl:text-[26px] font-medium text-white">
            We've seen firsthand the impact that a well-executed MVP can have on
            a business, and our team is committed to helping you achieve that
            same success.
          </p>
          <p className="text-base sm:text-xl xl:text-[26px] font-medium text-white">
            Here is how….
