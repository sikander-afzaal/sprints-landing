        ...
        {DummyDates.map((elem, idx) => {
          return (
            ...
            >
              ...
              <p className="text-blue font-bold w-min text-base sm:text-xl text-center leading-[1.2]">
                {elem}
              </p>
            </button>
          );
        ...
        {DummyTime.map((elem, idx) => {
          return (
            <button
              ...
              className={`w-full bg-lightBlue text-white text-xl font-bold ${
                elem.booked
              ...
              } border-2 border-solid h-[80px] rounded-xl`}
            >
